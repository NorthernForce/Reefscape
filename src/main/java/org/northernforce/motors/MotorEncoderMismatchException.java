...
/**
 * This is an exception that is thrown when there is invalid input to the
 * NFRMotorController's function to link encoders.
 */
public class MotorEncoderMismatchException extends Exception
{
	/**
	 * The constructor for a motor encoder mismatch exceptions. Forms a simple
	 * message outlining the encoder and motor types.
	 * 
