...
/**
 * A NFRMotorController is an interface that defines common funcionality amongst
 * many motor controller types, and it provides utility for dealing with
 * multiple motors following a primary motor.
 */
public interface NFRMotorController extends MotorController
{
	...
	/**
	 * Sets the inversion of the motor. Affects the integrated sensor, the external
	 * quadratures and pulse width absolutes that are directly plugged into the
	 * motor.
	 * 
	...
	/**
	 * Returns the integrated encoder built into the motor it is controller. This is
	 * different from an alternate quadrature that is separately pluggen into the
	 * motor controller.
	 * 
