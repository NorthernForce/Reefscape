...
/**
 * The NFRCANCoder is an interface for the CTRE CANCoder. This interface
 * inherits from NFRAbsoluteEncoder.
 */
public class NFRCANCoder implements NFRAbsoluteEncoder
{
	...
	/**
	 * Sets whether the absolute encoder is inverted. Also sets the relative
	 * encoder's inversion.
	 * 
	 * @param inverted true is clockwise, false is counter-clockwise.
	 */
	...
	/**
	 * Sets the conversion factor for the absolute sensor. Also affects the relative
	 * encoder.
	 * 
	 * @param factor 1 = 1 rotation.
	 */
	 ...
	 * 
	 * @param useAbsoluteMeasurements whether getPosition returns absolute
	 *                                measurements.
	 */
	@Override
	...
	/**
	 * Adds to the absolute simulation position of the encoder. Only use in
	 * simulation.
	 * 
	 * @param position in units determined by conversion factor.
	 */
	...
	public void setRange(boolean negative)
	{
		CANcoderConfiguration config = new CANcoderConfiguration();
		cancoder.getConfigurator().refresh(config);
		config.MagnetSensor.AbsoluteSensorRange = negative ? AbsoluteSensorRangeValue.Signed_PlusMinusHalf
