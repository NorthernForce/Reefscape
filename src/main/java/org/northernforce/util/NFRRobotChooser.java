...
public class NFRRobotChooser {
   ...
   *
   * @param defaultRobot default robot container should the file be nonexistant. Should be
   *     competition bot for purposes of fallbacks should anything happen to the roboRio.
   * @param otherRobots the map of other robots.
   * @param robotNamePath the path of where to find the file.
   */
  public NFRRobotChooser(
      Supplier<NFRRobotContainer> defaultRobot,
