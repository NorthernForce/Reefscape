...
/**
 * This is a simple abstract class that all northern force subsystems must
 * inherit from.
 */
public abstract class NFRSubsystem extends SubsystemBase
{
	/**
	 * This is a very simple configuration for this abstract subsystem that
	 * subsystem configurations must inherit from.
	 */
