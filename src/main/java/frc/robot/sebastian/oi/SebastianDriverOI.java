...
public class SebastianDriverOI implements SebastianOI
{
            ...
            SebastianContainer container)
    {
        ...
        manipulatorController.a().whileTrue(
                container.getSuperstructure().getGoToGoalCommand(SebastianConstants.SuperstructureGoal.CORAL_STATION_PRE).andThen(container.getSuperstructure().getGoToGoalCommand(SebastianConstants.SuperstructureGoal.CORAL_STATION)));
