...
public class SebastianProgrammerOI implements SebastianOI
{
    ...
    private void bindDrive(CommandXboxController driverController, SebastianContainer container)
    {
    ...
    private void bindClimber(CommandXboxController driverController, SebastianContainer container)
    {
