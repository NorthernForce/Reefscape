...
public class VisionConstants
{
	...
	public static Transform3d robotToCamera2 = new Transform3d(0, 0, 0, new Rotation3d(0, 0, 0));
	public static Transform3d robotToCamera3 = new Transform3d(0, 0, 0, new Rotation3d(0, 0, 0));
