...
public class Superstructure extends SubsystemBase
{
    ...
    {
        return new GoToGoalCommand(Superstructure.this, goal);
    }

    public Command holdAtGoal(SuperstructureGoal goal)
    {
        return new HoldAtGoalCommand(Superstructure.this, goal);
    }
    ...
    {
        return new HomingCommand(Superstructure.this, innerElevatorSpeed, outerElevatorSpeed);
    }

    public Command getManualControlCommand(DoubleSupplier innerElevatorSpeed, DoubleSupplier outerElevatorSpeed)
    {
        return new ManualControlCommand(Superstructure.this, innerElevatorSpeed, outerElevatorSpeed);
    }
