...
public class ModuleIOSparkMax implements ModuleIO
{
	...
	{
		inputs.drivePositionRad = Units.rotationsToRadians(driveEncoder.getPosition()) / Constants.DRIVE_GEAR_RATIO;
