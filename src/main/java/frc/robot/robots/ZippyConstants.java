...
public class ZippyConstants
{
    ...
    public static DriveConstants driveConstants = new DriveConstants(50, 3, 0.5, 0.5, 0.5, 3, 3, kDriveGearRatioL3, kTurnGearRatio, kWheelRadius, kWheelCircumference, kDriveP, kTurnP, kMaxDriveSpeed);
}
