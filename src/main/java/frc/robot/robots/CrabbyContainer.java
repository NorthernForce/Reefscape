...
public class CrabbyContainer
{
    ...
    public CrabbyContainer()
    {
        ...
        NamedCommands.registerCommand("Run Flywheel",
    ...
    private void configureButtonBindings()
    {
        ...
        controller.b().onTrue(Commands
                .runOnce(() -> drive.setPose(new Pose2d(drive.getPose().getTranslation(), new Rotation2d())), drive)
