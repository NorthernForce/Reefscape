...
public record TunerConstants(Slot0Configs steerGains, Slot0Configs driveGains,
        ...
        boolean kBackLeftCANcoderInverted, Distance kBackLeftXPos, Distance kBackLeftYPos,
        int kBackRightDriveMotorId, int kBackRightSteerMotorId, int kBackRightEncoderId,
        Angle kBackRightEncoderOffset, boolean kBackRightSteerMotorInverted, boolean kBackRightCANcoderInverted,
        Distance kBackRightXPos, Distance kBackRightYPos) {
