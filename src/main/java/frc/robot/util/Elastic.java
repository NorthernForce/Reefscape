...
public final class Elastic
{
	 ...
	 * object holds properties such as level, title, description, display time, and
	 * dimensions to control how the notification is displayed on the dashboard.
	 */
	public static class Notification
	{
		 ...
		 * time. If the height is below zero, it is automatically inferred based on
		 * screen size.
		 *
		 * @param level       the level of the notification
		 * @param title       the title text of the notification
