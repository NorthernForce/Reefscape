...
public class CloseDriveToPose extends Command
{
    ...
    private final PhoenixCommandDrive swerve;
    private Pose2d poseFinal, currentPose;

    private final PIDController xTranslationPID, yTranslationPID;
    private final PIDController rotationPID;

    public CloseDriveToPose(PhoenixCommandDrive swerve, Pose2d finalPose)
    {
        this.swerve = swerve;
        this.poseFinal = finalPose;
        this.xTranslationPID = new PIDController(RalphConstants.DrivetrainConstants.CLOSE_TRANSLATION_PP_KP,
                RalphConstants.DrivetrainConstants.CLOSE_TRANSLATION_PP_KI,
                RalphConstants.DrivetrainConstants.CLOSE_TRANSLATION_PP_KD);
        this.yTranslationPID = new PIDController(RalphConstants.DrivetrainConstants.CLOSE_TRANSLATION_PP_KP,
                RalphConstants.DrivetrainConstants.CLOSE_TRANSLATION_PP_KI,
                RalphConstants.DrivetrainConstants.CLOSE_TRANSLATION_PP_KD);
        this.rotationPID = new PIDController(RalphConstants.DrivetrainConstants.CLOSE_ROTATION_PP_KP,
